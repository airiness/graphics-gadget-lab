	...
	namespace
	{
		...
		void RunShaderCompileContractTests(SelfTestContext& context) noexcept
		{
			...
			context.Check(temporalAADxilArtifact.IsSuccess() &&
				...
				"Production DXC compiles TAA reprojection, point-sampled history age, split resolved/history alpha, depth rejection, YCoCg neighborhood clamp, and temporal blend for DX12 and Vulkan 1.3");
