...
namespace napa::voxel
{
	...
	ValidationResult testing::VoxelRestoreTestAccess::RestoreAllWithAllocationProbe(
	...
	ValidationResult testing::VoxelRestoreTestAccess::RestoreAllWithExhaustedRevision(
