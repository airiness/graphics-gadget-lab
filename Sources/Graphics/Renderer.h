...
namespace gglab
{
	...
	public:
		...
		const PersistentStructuredBufferTable<RenderMaterialKey, MaterialGPU>* GetMaterialStructuredBufferTable() const noexcept { return m_MaterialTable.get(); }
		PersistentStructuredBufferTable<RenderMaterialKey, MaterialGPU>* GetMaterialStructuredBufferTable() noexcept { return m_MaterialTable.get(); }
	...
	private:
		...
		std::unique_ptr<PersistentStructuredBufferTable<RenderMaterialKey, MaterialGPU>> m_MaterialTable;
