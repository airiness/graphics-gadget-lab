...
namespace gglab
{
	...
	{
	public:
		RenderPassIBLClear() noexcept :
			RenderPassBase({
				  .m_TypeName = "IBL.ClearFallback",
				  .m_DisplayName = "IBL Clear Fallback",
				  .m_CategoryName = "IBL",
				  .m_Description =
					  "Initializes the active IBL set to deterministic black resources before the first bake is published.",
		...
		void AddBakePass(RenderGraph& rg, const RenderFrameContext& context,
