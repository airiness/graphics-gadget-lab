...
#define GGLAB_GPU_STRUCTURE_ALIGNAS alignas(GGLAB_GPU_STRUCTURE_ALIGNAS_VALUE)
	...
	struct alignas(16) DirectionalShadowGPU
	{
		...
		uint32_t ReceiverPlaneCorrection = 0;
		float DistanceFadeStart = 0.0f;
		float DistanceFadeInvRange = 0.0f;
		float ShadowMetadataPadding = 0.0f;
	};
	static_assert(sizeof(DirectionalShadowGPU) == 112);
	static_assert(offsetof(DirectionalShadowGPU, BlendStart) == 80);
	static_assert(offsetof(DirectionalShadowGPU, ReceiverPlaneCorrection) == 96);
	static_assert(offsetof(DirectionalShadowGPU, DistanceFadeStart) == 100);
	static_assert(offsetof(DirectionalShadowGPU, DistanceFadeInvRange) == 104);
	static_assert(offsetof(DirectionalShadowGPU, ShadowMetadataPadding) == 108);
