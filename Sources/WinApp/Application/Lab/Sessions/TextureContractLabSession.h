...
namespace gglab
{
	class TextureContractLabSession final : public LabSessionBase
	{
	public:
		explicit TextureContractLabSession(const LabSessionCreateInfo& createInfo) noexcept;
		~TextureContractLabSession() override = default;
