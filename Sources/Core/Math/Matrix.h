...
namespace gglab::math
{
	...
	struct Matrix
	{
		...
		constexpr Matrix(float m00, float m01, float m02, float m03, float m10, float m11,
			float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31,
			float m32, float m33) noexcept :
			m_11(m00), m_12(m01), m_13(m02), m_14(m03), m_21(m10), m_22(m11), m_23(m12),
			m_24(m13), m_31(m20), m_32(m21), m_33(m22), m_34(m23), m_41(m30), m_42(m31),
			m_43(m32), m_44(m33)
		{
		}
