...
namespace gglab
{
	...
	public:
		...
		void SetRenderTargets(std::span<DX12DescriptorView> rtDescriptors, const DX12Descriptor* dsDescriptor) const noexcept;
		...
		void SetGraphicsDescriptor(uint32_t parameterIndex, const DX12Descriptor& descriptor) const noexcept;
